                ...
                <div className="row grid md:flex gap-20 px-10 md:px-25 py-10 text-white">
                    <div className="contact-left">
                        ...
                        <div className="text-2xl text-[#ababab] mb-10">
                            <a href="https://www.instagram.com/ved_prakash_007/"target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faInstagram} className="mr-5 hover:text-[#ff004f] duration-600 ease-in-out"/></a>
